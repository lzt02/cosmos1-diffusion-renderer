...
"${metashape_path}/metashape" -r mesh_tools/scripts/texture_mesh.py --images_dir "$dir/merge_metallic_resize" --cameras_dir "$dir/sparse/0" --model_path "$dir/3DModel.obj" --method "metashape" --texture_size 4096  -platform offscreen
